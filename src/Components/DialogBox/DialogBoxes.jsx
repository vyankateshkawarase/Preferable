...
//             iconOnly={false}
//             ripple="light"
//             className="text-white font-poppins text-lg w-64 h-16 p-0 gap-2 rounded-3xl border border-[#FF8400] bg-[#3626A7]"
//           >
//             Upload Resume
//           </Button>
...
//             iconOnly={false}
//             ripple="light"
//             className="text-[#3626A7] text-center items-center font-poppins font-semibold text-xl pr-8 m-4 ml-auto"
//           >
//             Back
//           </Button>
//           <Button
...
//             iconOnly={false}
//             ripple="light"
//             className="flex items-center justify-center w-20 h-10 p-0 md:p-0 m-2 flex-shrink-0 rounded-3xl text-[#FFFFFF] bg-[#657ED4]"
//           >
//             Next
//           </Button>
//         </div>
